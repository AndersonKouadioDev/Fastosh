  ...
  return (
    <div className="grid grid-flow-col sm:grid-cols-3 gap-x-4 overflow-x-auto py-4">
      {items.map((item, index) => (
        <div
          key={index}
          className="flex flex-col lg:flex-row lg:items-center justify-start gap-2 bg-primary-900 text-white hover:bg-primary min-h-16 min-w-40 px-4 py-2 rounded-xl text-lg transition-colors duration-200"
        >
